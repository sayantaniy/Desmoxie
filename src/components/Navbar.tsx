...
const Navbar = () => {
  return (
    <div className='bg-lime-700 fixed top-6 left-1/2 transform -translate-x-1/2 w-[70%] text-white px-5 py-3 text-xl rounded-full font-googlesans flex justify-between font-bold'>
